...
class SaveDialogInputThread(threading.Thread):
    def __init__(self, filename, initial_delay=SAVE_DIALOG_INITIAL_DELAY, detect_timeout=SAVE_DIALOG_DETECT_TIMEOUT,
                 template_image=SAVE_DIALOG_IMAGE, fallback_pos=FALLBACK_INPUT_POS):
...
def main():
    ...
    for idx, text in enumerate(texts, start=1):
        try:
            ...
            save_thread = SaveDialogInputThread(filename=number,
